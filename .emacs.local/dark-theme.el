...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Removed custom mode-line colors to use Emacs default
   ;; `(mode-line ((,class (:background ,bracket :foreground "#000000" :box (:line-width 3 :color "#000000" :style nil)))))
   ;; `(mode-line-inactive ((,class (:background ,bg :foreground ,comment :box (:line-width 3 :color "#000000" :style nil)))))
   ;; `(mode-line-buffer-id ((,class (:foreground ,bg :weight bold :box (:line-width 2 :color "#000000")))))
